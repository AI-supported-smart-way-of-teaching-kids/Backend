...
class Video(TimeStampedModel):
    ...
    storage_key = models.CharField(max_length=1024, blank=True, null=True)  # S3 key or similar
    url = models.CharField(max_length=2048)  # playback URL or signed URL
    uploaded_by = models.ForeignKey("users.User", null=True, blank=True, on_delete=models.SET_NULL, related_name="uploaded_videos")
...
class Lesson(TimeStampedModel):
    ...
    teacher = models.ForeignKey("users.User", null=True, blank=True, on_delete=models.SET_NULL, related_name="lessons")
    # lesson may reference a primary video; additional videos can be added via a join table if needed
    video = models.ForeignKey("content.Video", null=True, blank=True, on_delete=models.SET_NULL, related_name="lessons")
...
class Question(models.Model):
    ...
    quiz = models.ForeignKey("content.Quiz", on_delete=models.CASCADE, related_name="questions")
...
class Choice(models.Model):
    question = models.ForeignKey("content.Question", on_delete=models.CASCADE, related_name="choices")
