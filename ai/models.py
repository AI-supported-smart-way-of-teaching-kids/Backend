...
class MLStudentMap(models.Model):
    ...
    student_uuid = models.UUIDField(
        null=True, blank=True, db_index=True, help_text="UUID from User model"
    )
...
class BaseInteractionModel(models.Model):
    ...
    child = models.ForeignKey(
        ChildProfile, on_delete=models.SET_NULL, null=True, blank=True, related_name="+"
    )
...
class Recommendation(models.Model):
    ...
    child = models.ForeignKey(
        ChildProfile, on_delete=models.PROTECT, related_name="recommendations"
    )
    lesson = models.ForeignKey(
        "lessons.Lesson", on_delete=models.PROTECT, related_name="recommendations"
    )
