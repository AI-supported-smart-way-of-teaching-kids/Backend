...
class ProgressClean(BaseInteractionModel):
    ...
    lessons_completed = models.IntegerField(
        validators=[MinValueValidator(0)], help_text="Validated lesson count"
    )
    ...
    class Meta:
        ...
        indexes = [models.Index(fields=["cleaned_at"])]
...
class ProgressLabeled(BaseInteractionModel):
    ...
    class Meta:
        ...
        indexes = [models.Index(fields=["mastery_level", "computed_at"])]
