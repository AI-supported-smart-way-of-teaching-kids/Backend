...
from .models import (
    LessonInteractionsRaw, LessonInteractionsClean,
    QuizAttemptsRaw, QuizAttemptsClean,
    ProgressRaw, ProgressClean,
    LessonFeatures, QuizFeatures,
    ProgressLabeled, StudentMLDataset
)
...
class QuizAttemptsRawAdmin(admin.ModelAdmin):
    list_display = ('ml_student_id', 'lesson_id', 'score', 'attempt_number', 'received_at')
